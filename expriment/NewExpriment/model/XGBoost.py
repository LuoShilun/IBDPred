...
DATASETS = {
    ...
    "Autoencoder": "../train/dataset/Autoencoder_train.csv"
}
...
def xgb_full_pipeline(data_type):
    ...
    joblib.dump(best_model, f'./ModelPKL/xgb_best_{data_type}.pkl')
...
def plot_combined_roc(rf_data, mi_data):
    ...
    plt.savefig('./resultsImage/combined_roc.png', dpi=300, bbox_inches='tight')
    plt.close()
