...
if __name__ == "__main__":
    ...
    for feature_method in ['rf', 'mi']:
        ...
        estimators = [
            ...
            ('xgb', XGBClassifier(random_state=2025, learning_rate=0.1 if 'mi' in feature_method else 0.1,
                                  max_depth=3 if 'mi' in feature_method else 3,
                                  gamma=0.4 if 'mi' in feature_method else 0.3,
                                  n_estimators=30 if 'mi' in feature_method else 200,
                                  subsample=0.8 if 'mi' in feature_method else 1.0,
                                  colsample_bytree=0.4 if 'mi' in feature_method else 0.4)),
            ('rf', RandomForestClassifier(random_state=2025, n_estimators=40 if 'mi' in feature_method else 70,
                                          max_depth=10 if 'mi' in feature_method else 12,
                                          min_samples_split=2 if 'mi' in feature_method else 2))
        ]
