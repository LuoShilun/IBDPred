...
def plot_ensemble_models_from_saved_data():
    ...
    try:
        # 加权平均模型
        average_results = load_cv_results('average_cv_results.pkl')
    ...
    try:
        # 软投票模型
        voting_results = load_cv_results('voting_cv_results.pkl')
    ...
    try:
        # 标准Stacking模型
        stacking_results = load_cv_results('stacking_cv_results.pkl')
    ...
    try:
        # 改进Stacking模型
        improved_stacking_results = load_cv_results('stacking_improved_cv_results.pkl')
